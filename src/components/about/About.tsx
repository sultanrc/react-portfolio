        ...
        <div className="lg:w-3/5 flex flex-col">
          ...
          <div className="text-xs md:text-[16px] text-stone-400 mb-4 leading-relaxed">
            <p>
              ...
              internship, where I got to design a dashboard screen in Figma and
              then turn it into a real webpage using HTML and CSS. Seeing my
              designs come to life on the screen was so exciting – that's when I
