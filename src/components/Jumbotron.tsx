export default function Jumbotron() {
  return (
    <div className="min-h-screen flex items-center ">
      <div className="flex flex-col items-start gap-6 md:mx-20 lg:mx-40">
        <div className="flex flex-col">
          <p className="text-xl md:text-2xl lg:text-3xl font-light text-gray-200">
            Hello, world, my name is
          </p>
          <h1 className="text-[36px] md:text-[60px] font-bold text-white">
            Muhammad Sultan.
          </h1>
          <p className="text-[32px] md:text-[40px] lg:text-[56px] font-bold text-stone-300">
            I bring designs to life on the web.
          </p>
        </div>
        <p className="text-xl md:text-2xl font-light text-stone-300 max-w-xl">
